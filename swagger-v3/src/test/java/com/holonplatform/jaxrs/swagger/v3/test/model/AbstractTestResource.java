 ...
 * the License.
 */
package com.holonplatform.jaxrs.swagger.v3.test.model;
...
public abstract class AbstractTestResource {
	...
	public @PropertySetRef(Model1.class) PropertyBox test1() {
		return PropertyBox.builder(Model1.PROPERTIES).set(Config.ID, 1).build();
	}
	...
	public @PropertySetRef(Model1.class) PropertyBox[] test3() {
		return new PropertyBox[] { PropertyBox.builder(Model1.PROPERTIES).set(Config.ID, 1).build() };
	}
	...
	public @PropertySetRef(Model1.class) List<PropertyBox> test4() {
		return Collections.singletonList(PropertyBox.builder(Model1.PROPERTIES).set(Config.ID, 1).build());
	}
	...
	public @PropertySetRef(Model1.class) Set<PropertyBox> test5() {
		return Collections.singleton(PropertyBox.builder(Model1.PROPERTIES).set(Config.ID, 1).build());
	}
	...
	public @PropertySetRef(Model2.class) PropertyBox test6() {
		return PropertyBox.builder(Model2.PROPERTIES).set(Config.ID, 1).build();
	}
