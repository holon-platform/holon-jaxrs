...
import com.holonplatform.jaxrs.swagger.v3.test.ctxresources.CtxResource1;
...
@ActiveProfiles("groups2")
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
public class TestOpenApiAutoConfigurationGroups2 {

	@LocalServerPort
	private int port;

	@ComponentScan(basePackageClasses = CtxResource1.class)
	...
	public static void validate(OpenAPI api, String description, String path) {
		...
		assertEquals("Title groups2", info.getTitle());
