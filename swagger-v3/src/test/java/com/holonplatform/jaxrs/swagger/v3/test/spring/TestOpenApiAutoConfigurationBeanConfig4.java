...
import com.holonplatform.jaxrs.swagger.v3.test.ctxresources2.Ctx2Resource1;
...
public class TestOpenApiAutoConfigurationBeanConfig4 {
	...
	private static class ApiConfig1 extends SwaggerConfiguration {
		...
		public ApiConfig1() {
			super();
			setOpenAPI(new OpenAPI().info(new Info().title("Test bean config 4_1").version("1.9.1")));
		}
	...
	private static class ApiConfig2 extends SwaggerConfiguration {
		...
		public ApiConfig2() {
			super();
			setOpenAPI(new OpenAPI().info(new Info().title("Test bean config 4_2").version("1.9.2")));
		}
