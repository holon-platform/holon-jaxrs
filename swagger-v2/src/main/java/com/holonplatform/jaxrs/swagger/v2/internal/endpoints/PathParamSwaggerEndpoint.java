 ...
 * @since 5.2.0
 */
public class PathParamSwaggerEndpoint extends AbstractSwaggerEndpoint {
	...
	public Response getSwaggerApi(@Context HttpHeaders headers, @Context UriInfo uriInfo, @PathParam("type") String type) {
