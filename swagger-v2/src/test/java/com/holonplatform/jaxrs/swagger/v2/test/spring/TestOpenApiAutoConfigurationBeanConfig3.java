...
public class TestOpenApiAutoConfigurationBeanConfig3 {
	...
	private static class ApiConfig1 extends BeanConfig {
		...
		public ApiConfig1() {
			super();
			setInfo(new Info().title("Test bean config 3_1").version("1.8.1"));
			setResourcePackage(Resource2.class.getPackage().getName());
		}
	...
	private static class ApiConfig2 extends BeanConfig {
		...
		public ApiConfig2() {
			super();
			setInfo(new Info().title("Test bean config 3_2").version("1.8.2"));
			setResourcePackage(Resource3.class.getPackage().getName());
		}
