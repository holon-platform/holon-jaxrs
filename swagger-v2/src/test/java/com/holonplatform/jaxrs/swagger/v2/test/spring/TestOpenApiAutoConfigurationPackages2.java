...
public class TestOpenApiAutoConfigurationPackages2 {
	...
	public static void validate(Swagger api) {
		...
		SwaggerValidation.validateModel1(SwaggerValidation.validateOperationResponse(api, "/resource2/test21"));
		SwaggerValidation.validateModel1(SwaggerValidation.validateOperationResponse(api, "/resource3/test31"));
	}
